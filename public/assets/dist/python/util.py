...
def update_entry(license_plate, table):
    ...
    if result:
        ...
        transaction_query = """
            INSERT INTO transactions (plate_num, time, status, type)
            VALUES (%s, %s, %s, %s)
        """
        db_cursor.execute(transaction_query, (license_plate, entry_time, new_status, transaction_type))
